...
class TerminatedCommissionerProjectsExport implements FromView, WithProperties, WithEvents
{
    ...
    {
        $projects = Project::where('project_status', 0)
    ...
    {
        return [
            'title' => 'EXCEL - PROYECTOS FINALIZADOS',
