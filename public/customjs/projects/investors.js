function addInvestor() {
    ...
    newRow.innerHTML = `
      ...
      <td>
        <input type="number" name="investor_investment[]" style="font-size: clamp(0.6rem, 6vh, 0.68rem)" placeholder="Inversión" min="0" class="form-control" required oninput="calculateTotalInvestment()">
