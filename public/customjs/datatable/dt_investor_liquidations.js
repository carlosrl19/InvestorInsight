(function ($) {
    ...
    var table = $("#exampleLiquidations").DataTable({
        dom: "lBfrtip",
        initComplete: function () {
            ...
            api.columns()
                ...
                .each(function (colIdx) {
                    ...
                    if (colIdx < api.columns().eq(0).length) {
                        ...
                        var $input = $(
                            '<input type="text" data-kt-filter="search" id="search-filters-liquidations" style="width: 100%;" placeholder="' +
                                title +
                                '" />'
                        );

                        $input
                            .appendTo($("#search-filters-liquidations-container"))
            ...
            $(
                ...
                .on("click", function () {
                    ...
                    $("#search-filters-liquidations-container input").val("");
