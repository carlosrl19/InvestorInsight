(function($) {
    ...
    $("input").on("keyup change", function() {
        if ($(this).parent().index() < $("#example thead th").length - 3) {
        ...
        var totalUnionQuota = table.column(5, { search: 'applied' }).data().reduce(function(a, b) {
            return parseFloat(a) + parseFloat(b);
        }, 0);
        var totalMortuaryPlanPayment = table.column(6, { search: 'applied' }).data().reduce(function(a, b) {
            return parseFloat(a) + parseFloat(b);
        }, 0);

        $("#example tfoot th:nth-child(6)").text('Lps. ' + totalUnionQuota.toFixed(2));
        $("#example tfoot th:nth-child(7)").text('Lps. ' + totalMortuaryPlanPayment.toFixed(2));
    });
