(function ($) {
    ...
    var table = $("#exampleLoans").DataTable({
        dom: "lBfrtip",
        initComplete: function () {
            ...
            api.columns()
                ...
                .each(function (colIdx) {
                    ...
                    if (colIdx < api.columns().eq(0).length - 2) {
                        ...
                        var $input = $(
                            '<input type="text" data-kt-filter="search" id="search-filters-loans" style="width: 100%;" placeholder="' +
                                title +
                                '" />'
                        );

                        $input
                            .appendTo($("#search-filters-loans-container"))
            ...
            $(
                ...
                .on("click", function () {
                    ...
                    $("#search-filters-loans-container input").val("");
