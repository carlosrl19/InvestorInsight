            ...
            <table id="moneylenders" class="display table table-bordered">
                ...
                <tbody>
                    @foreach($moneylenders as $i => $moneylender)
                                ...
                                <div class="btn-list flex-nowrap">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                data-bs-target="#modal-loans-{{ $moneylender->id }}">
                                                <img style="filter: invert(42%) sepia(9%) saturate(0%) hue-rotate(136deg) brightness(99%) contrast(93%);"
                        ...
                        <div class="modal modal-blur fade" id="modal-update-{{ $moneylender->id }}"
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" maxlength="13"
                                                            value="{{ $moneylender->moneylender_dni }}"
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <textarea maxlength="255"
                                                            ...
                                                            autocomplete="off"
                                                            oninput="this.value = this.value.toUpperCase()">{{ $moneylender->moneylender_description }}</textarea>
                        ...
                        <!-- Modal de actualización específico para cada prestamista -->
                        <div class="modal modal-blur fade" id="modal-loans-{{ $moneylender->id }}" data-bs-backdrop="static"
                                                ...
                                                <div class="col" style="display: none">
                                                    <div class="form-floating">
                                                        <input type="datetime-local" name="creditNote_date"
                                                            style="font-size: 10px;" value="{{ $creditNoteDate }}"
                                                            id="creditNote_date" min="{{ $creditNoteDate }}"
                                                            max="{{ $creditNoteDate }}"
                                                        ...
                                                        <select class="form-select" id="investor_id" name="investor_id"
                                                            ...
                                                            @foreach ($investors as $investor)
                                                                <option value="{{ $investor->id }}"
                                                                    data-balance="{{ $investor->investor_balance }}" {{ old('investor_id') == $investor->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col">
                                                        <div class="form-floating">
                                                            <textarea maxlength="255"
                                                                ...
                                                                class="form-control @error('moneylender_description') is-invalid @enderror"
                                                                autocomplete="off"
                                                                oninput="this.value = this.value.toUpperCase()">{{ old('moneylender_description') }}</textarea>
                                                            @error('moneylender_description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
