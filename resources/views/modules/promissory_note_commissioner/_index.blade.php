                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="promissoryNotes" class="display table table-bordered">
                                ...
                                <tbody>
                                    @foreach($promissoryNoteCommissioners as $promissoryCommissionerNote)
                                        <tr class="text-center">
                                            <td>#{{ $promissoryCommissionerNote->promissoryNoteCommissioner_code }}</td>
                                            <td>{{ $promissoryCommissionerNote->promissoryNoteCommissioner_emission_date }}</td>
                                            <td>{{ $promissoryCommissionerNote->promissoryNoteCommissioner_final_date }}</td>
                                            <td>
                                                <a href="{{ route('commission_agent.show', $promissoryCommissionerNote->commissioner) }}">{{ $promissoryCommissionerNote->commissioner->commissioner_name }}
                                                    <small>
                                                        <sup>
                                            ...
                                            <td>Lps. {{ number_format($promissoryCommissionerNote->promissoryNoteCommissioner_amount, 2) }}</td>
                                            <td>
                                                @if($promissoryCommissionerNote->promissoryNoteCommissioner_status == '1')
                                                    <span class="badge bg-orange me-1"></span> Emitido / Sin pagar
                                                @elseif($promissoryCommissionerNote->promissoryNoteCommissioner_status == '0')
                                            ...
                                            <td>
                                                <a href="{{ route('promissory_note_commissioner.report', $promissoryCommissionerNote->id) }}" class="btn btn-sm btn-red"
