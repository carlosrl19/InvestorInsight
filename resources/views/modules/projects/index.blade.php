        ...
        <table id="example" class="display table table-bordered">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $project->investor_dni }}</td>
                        <td>{{ $project->investor_phone }}</td>
                        <td>{{ $project->investor_reference }}</td>
                        <td>
                            @if($project->investor_status == '1')
                                <span class="badge bg-success me-1"></span> Disponible
                            @elseif($project->investor_status == '0')
                        ...
                        <td>
                            @include('modules.project._delete')
