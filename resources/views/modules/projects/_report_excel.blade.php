    ...
    <tbody>
        ...
        <tr>
            ...
            @foreach($project->investors as $investor)
                <td style="font-size: 14px; width: 150px; font-weight: bold; background-color: #fff; text-align: center; text-decoration: underline;">PROYECTOS ACTIVOS {{ $investor->investor_name }}</td>
            @endforeach
