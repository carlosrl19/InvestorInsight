...
@section('pretitle')
Comisionistas <small>({{ number_format($loadTime, 2) }} segundos)</small>
@endsection
...
<b class="text-muted">{{ $commissioner->commissioner_name }}</b>
@endsection
                ...
                <div class="card mb-2">
                    <div class="card-body d-flex align-items-center">
                        <div class="col-auto me-4">
                            <img src="{{ asset('../static/svg/user-scan.svg') }}" width="90" height="90" alt="commissioner-image">
                        </div>
                        <div class="col">
