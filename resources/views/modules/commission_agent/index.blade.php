                        ...
                        <div class="btn-list flex-nowrap">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="{{ route('commission_agent.edit', $commission_agent) }}" data-bs-toggle="modal" data-bs-target="#modal-team-update">
...
@include('modules.commission_agent.update')
