...
<div class="list-group list-group-flush list-group-hoverable">
    ...
    <div class="list-group-item">
        <div class="row align-items-center">
            ...
            <div class="col">
                <a href="#" class="text-body d-block" style="font-size: clamp(0.7rem, 6vh, 0.8rem)">Pagaré #{{ $promissoryNote->promissoryNote_code }}</a>
                <div class="d-block text-muted mt-n1" style="font-size: clamp(0.6rem, 6vh, 0.7rem)">
                   Fecha de pago {{ $promissoryNote->promissoryNote_final_date}}.
                </div>
            </div>
        </div>
    </div>
