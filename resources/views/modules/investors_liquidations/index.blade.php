                            ...
                            <tbody>
                                @foreach($investorLiquidations as $investorLiquidation)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-red" style="font-size: clamp(0.6rem, 3vw, 0.6rem)" href="{{ route('investors_liquidations.report', $investorLiquidation)}}" data-toggle="modal" data-target="#pdfModal">
