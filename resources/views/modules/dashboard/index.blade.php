							...
							<div class="row align-items-center">
								<div class="col-auto">
									<span class="bg-orange text-white avatar">
										<img style="filter: invert(100%) sepia(100%) saturate(0%) hue-rotate(158deg) brightness(103%) contrast(103%);" src="{{ asset('../static/svg/chart.svg') }}" width="20" height="20">
									</span>
								</div>
								<div class="col">
									<div class="font-weight-medium">
								...
								<div style="margin-right: -40vh;" class="col">
									<a href="{{ route('dashboard.general_export')}}" class="badge bg-teal me-1 text-white" style="padding-right: 30px">
