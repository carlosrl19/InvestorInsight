        ...
        <div class="modal-content" style="border: 2px solid #883939">
            ...
            <form action="{{ route('provider.destroy', $provider->id) }}"
                ...
                <div class="modal-body">
                    ...
                    <p>Está a punto de tomar una acción permanente e irreversible: eliminar por completo al proveedor <strong style="text-transform: uppercase">{{ $provider->provider_name }}</strong>. 
                    Esto borrará todo rastro de su actividad, incluyendo historial de pagos y cualquier otro dato relacionado.</p>
                    
                    <p>Antes de proceder, se recomienda verificar cuidadosamente que esta es la acción correcta. Una vez eliminado, no habrá forma de recuperar la información del proveedor.</p>
