            ...
            <div class="d-none d-md-flex">
              ...
              <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Activar modo claro"
                ...
                <img
                  ...
                  src="{{ asset('../static/svg/sun.svg') }}" width="20" height="20">
              </a>
            </div>
                  ...
                  <a class="nav-link" href="{{ route('dashboard.index')}}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        ...
                        src="{{ asset('../static/svg/dashboard.svg') }}" width="20" height="20">
                    </span>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown"
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        style="filter: invert(68%) sepia(0%) saturate(0%) hue-rotate(177deg) brightness(98%) contrast(89%);"
                        src="{{ asset('../static/svg/building-fortress.svg') }}" width="20" height="20">
                    </span>
                    <span class="nav-link-title">
                      Proyectos
                    </span>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        style="filter: invert(68%) sepia(0%) saturate(0%) hue-rotate(177deg) brightness(98%) contrast(89%);"
                        src="{{ asset('../static/svg/users-group.svg') }}" width="20" height="20">
                    </span>
                    <span class="nav-link-title">
                      Recursos humanos
                    </span>
                    ...
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('investor.future_capital') }}">
                              <small>->&nbsp;</small>Future Capital
                            </a>
                            <a class="dropdown-item" href="{{ route('investor.jaguer') }}">
                              <small>->&nbsp;</small>Jaguer Group S. de R.L.
                            </a>
                            <a class="dropdown-item" href="{{ route('investor.marsella') }}">
                              <small>->&nbsp;</small>Marsella
                            </a>
                            <a class="dropdown-item" href="{{ route('investor.robenior') }}">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown"
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        style="filter: invert(68%) sepia(0%) saturate(0%) hue-rotate(177deg) brightness(98%) contrast(89%);"
                        src="{{ asset('../static/svg/report.svg') }}" width="20" height="20">
                    </span>
                    <span class="nav-link-title">
                      Reportes
                    </span>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown"
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        style="filter: invert(68%) sepia(0%) saturate(0%) hue-rotate(177deg) brightness(98%) contrast(89%);"
                        src="{{ asset('../static/svg/coins.svg') }}" width="20" height="20">
                    </span>
                    <span class="nav-link-title">
                      Contabilidad
                    </span>
                  ...
                  <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown"
                    ...
                    <span class="text-red nav-link-icon d-md-none d-lg-inline-block">
                      <img
                        ...
                        src="{{ asset('../static/svg/circle-letter-r.svg') }}" width="20" height="20">
                    </span>
                    <span class="nav-link-title">
                        ...
                        <a class="dropdown-item">
                          <strong style="margin: auto;">
                            <img
                              ...
                              src="{{ asset('../static/svg/arrows-up.svg') }}" width="20" height="20" alt="">
                            MOVIMIENTOS ACTIVOS
                          </strong>
                        </a>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_investor_profit_payment, 2) }}</td>
                            </tr>
                            <tr>
                              <td style="border-left: 1px solid green; font-size: clamp(0.6rem, 3vw, 0.62rem)">Pago a
                                comisionistas</td>
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_commissioner_commission_payment, 2) }}</td>
                            </tr>
                            <tr>
                              <td style="border-left: 1px solid green; font-size: clamp(0.6rem, 3vw, 0.62rem)">Inversión
                                de proyectos en proceso</td>
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_project_investment, 2) }}</td>
                            </tr>
                          </tbody>
                        </table>
                        <a class="dropdown-item">
                          ...
                          <tbody>
                            <tr>
                              <td style="border-left: 1px solid red; font-size: clamp(0.6rem, 3vw, 0.62rem)">Pagos a
                                inversionistas</td>
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_investor_profit_paid, 2) }}</td>
                            </tr>
                            <tr>
                              <td style="border-left: 1px solid red; font-size: clamp(0.6rem, 3vw, 0.62rem)">Pagos a
                                comisionistas</td>
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_commissioner_commission_paid, 2) }}</td>
                            </tr>
                            <tr>
                              <td style="border-left: 1px solid red; font-size: clamp(0.6rem, 3vw, 0.62rem)">Inversión
                                de proyectos finalizados</td>
                              <td style="font-size: clamp(0.6rem, 3vw, 0.62rem)">Lps.
                                {{ number_format($total_project_investment_terminated, 2) }}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
