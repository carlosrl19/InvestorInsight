...
<a href="#" class="btn btn-orange" style="font-size: clamp(0.6rem, 6vh, 0.7rem);" data-bs-toggle="modal" data-bs-target="#modal-promissoryInvestorNotes">
    <img style="filter: invert(100%) sepia(0%) saturate(7398%) hue-rotate(181deg) brightness(105%) contrast(102%); margin-right: 5px" src="<?php echo e(asset('../static/svg/receipt.svg')); ?>" width="20" height="20" alt="">
        ...
        <table id="investorPayments" class="display table table-bordered">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="text-red">
                        <a href="<?php echo e(route('payments_investor.report', $payment->id)); ?>" class="badge bg-red me-1 text-white" data-toggle="modal" data-target="#pdfModal">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carlos Rodriguez\Desktop\Code\InvestorInsight\resources\views/modules/payment_investors/index.blade.php ENDPATH**/ ?>