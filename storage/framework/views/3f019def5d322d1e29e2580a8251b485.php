...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('excel_project_id')): ?>
        <script>
            ...
            function redirectToExcel() {
                window.location.href = "<?php echo e(route('project.excel', session('excel_project_id'))); ?>";
                setTimeout(redirectoToPromissoryNote, 1000);
            }

            function redirectoToPromissoryNote() {
                window.location.href = "<?php echo e(route('promissory_note.report_download', session('excel_project_id'))); ?>";
            }
        </script>
    <?php endif; ?>
    ...
    <?php if(session('project_id')): ?>
        <script>
            ...
            function redirectToTermination() {
                window.location.href = "<?php echo e(route('project.termination', session('project_id'))); ?>";
                setTimeout(redirectToExcel, 1000); // Descarga archivo Excel al segundo (1000 milisegundos)
            }

            function redirectToExcel() {
                window.location.href = "<?php echo e(route('project.excel', session('project_id'))); ?>";
            }
        </script>
    <?php endif; ?>
                                    ...
                                    <div class="modal-content">
                                        <form action="<?php echo e(route('project.finish', $project->id)); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-8">
                                                        ¿Desea cambiar el estado del proyecto <b><?php echo e($project->project_name); ?></b> a "Finalizado"? Utilize esta opción únicamente cuando un proyecto haya concluido de forma exitosa.
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo e(route('project.close', $project->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-body">
                                                ¿Desea cambiar el estado del proyecto <b><?php echo e($project->project_name); ?></b> a "Cerrado"? Utilice esta opción únicamente cuando un proyecto tenga conflictos para llevarse a cabo y no se pueda seguir con el mismo.
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /run/media/carlos/ROBENIOR/Code/En proceso/InvestorInsight/resources/views/modules/projects/index.blade.php ENDPATH**/ ?>