<title>#NC-<?php echo e($creditNote->creditNote_code); ?></title>
...
<div class="main">
	...
	<div class="code-container-right">
		<span class="text-bold">#NC-<?php echo e($creditNote->creditNote_code); ?></span>
	</div>
	
	<!-- Credit's note title -->
	<div class="title-note mt-center">
		NOTA CREDITO POR LPS <?php echo e(number_format($creditNote->creditNote_amount,2 )); ?>

	</div>

	<!-- Credit's note body -->
	<div class="body-note mt-4 mb-4">
		Por la presente, se emite la siguiente nota de crédito a favor del inversionista <strong><?php echo e($creditNote->investor->investor_name); ?></strong>, identificado con su número de identidad 
		<strong><?php echo e($creditNote->investor->investor_dni); ?></strong>, número de teléfono <strong><?php echo e($creditNote->investor->investor_phone); ?></strong>, con un valor total de Lps. <strong><?php echo e(number_format($creditNote->creditNote_amount,2)); ?></strong>.
	</div>
	...
	<div class="reason-note-body">
		<?php echo e($creditNote->creditNote_description); ?>
...
</style><?php /**PATH C:\Users\Carlos Rodriguez\Downloads\InvestorInsight\resources\views/modules/credit_note/_report.blade.php ENDPATH**/ ?>