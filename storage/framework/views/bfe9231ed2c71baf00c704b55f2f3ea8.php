    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php echo e($project->project_investment); ?></td>
                <td></td>
                <td></td>
            </tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td style="background-color: #569a40; font-size: 11px; font-weight: bold; text-align: center;"><?php echo e($totalTransferAmount); ?></td>
                <td></td>
                <td></td>
                <td></td>
            </tr>
