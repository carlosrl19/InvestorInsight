<title><?php echo e($investor->investor_name); ?> - #LQ-<?php echo e($investorLiquidation->liquidation_code); ?></title>
...
<div class="main">
	...
	<div class="code-container-right">
		<span class="text-bold">#LQ-<?php echo e($investorLiquidation->liquidation_code); ?></span>
	</div>
	...
	<div class="body-note mb-4">
		Por medio de este documento, <strong>JUNIOR ALEXIS AYALA GUERRERO</strong> formaliza la liquidación de la cuenta del inversionista <strong class="text-uppercase"><?php echo e($investor->investor_name); ?></strong>, 
		en San Pedro Sula, Cortés, Honduras, con fecha <strong><?php echo e($day); ?>/<?php echo e($month); ?>/<?php echo e($year); ?></strong>, por un monto total de Lps. <strong><?php echo e(number_format($investorLiquidation->investor_liquidation_amount,2)); ?></strong>. 
		...
		<?php else: ?>
			El pago se realizó a través de <strong><?php echo e($investorLiquidation->liquidation_payment_mode); ?></strong> siendo detallado de la siguiente manera:
		<?php endif; ?>
		...
		<table class="table mt-4 mb-4">
			...
			<tbody>
				<?php
					$i = 1;
				?>
				<?php $__currentLoopData = explode("\n", $investorLiquidation->liquidation_payment_comment); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td style="font-size: 12px; text-align: center;"><?php echo e($i++); ?></td>
						<td style="font-size: 12px; text-align: left;"><?php echo e($line); ?></td>
					</tr>
...
</style><?php /**PATH C:\Users\Carlos Rodriguez\Downloads\InvestorInsight\resources\views/modules/investors_liquidations/_report_liquidation.blade.php ENDPATH**/ ?>