    ...
    <tbody>
        ...
        <?php $__currentLoopData = $investorCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investorCommission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td></td> <!-- Merge con td anterior -->
                <td style="border: 1px solid #000; text-align: center; background-color: #F8E4CC;">L. <?php echo e(number_format($investorCommission->investor_investment, 2)); ?></td>
                <td style="border: 1px solid #000; text-align: center; background-color: #F8E4CC;">L. <?php echo e(number_format($investorCommission->investor_final_profit, 2)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td></td>
                <td></td>
                <td style="background-color: #E69C46; font-weight: bold; border: 1px solid #000; text-align: center;">L. <?php echo e(number_format($totalInvestorInvestment, 2)); ?></td>
                <td style="background-color: #E69C46; font-weight: bold; border: 1px solid #000; text-align: center;">L. <?php echo e(number_format($totalInvestorCommissions, 2)); ?></td>
            </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $commissionerCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commissionerCommission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td></td> <!-- Merge con td anterior -->
                <td style="border: 1px solid #000; text-align: center; background-color: #F8E4CC">L. <?php echo e(number_format($commissionerCommission->commissioner_commission, 2)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td></td>
                ...
                <td></td>
                <td></td>
                <td style="background-color: #E69C46; font-weight: bold; border: 1px solid #000; text-align: center;">L. <?php echo e(number_format($totalCommissionerCommissions, 2)); ?></td>
            </tr>
    </tbody>
</table><?php /**PATH /home/carlos/Code/InvestorInsight/resources/views/modules/dashboard/_commissions_report.blade.php ENDPATH**/ ?>