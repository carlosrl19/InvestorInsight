							...
							<div class="row align-items-center">
								...
								<div style="margin-right: -35vh;" class="col">
									<a href="#" data-bs-toggle="modal" data-bs-target="#modal-filters" class="badge bg-dark me-1 text-white">
										<img style="filter: invert(100%) sepia(0%) saturate(7398%) hue-rotate(181deg) brightness(105%) contrast(102%);" src="<?php echo e(asset('../static/svg/filter.svg')); ?>" width="20" height="20" alt="">
										MOSTRAR FILTROS
                                	</a>
								</div>
									...
									<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
										<div class="modal-content" style="border: 2px solid #52524E">
											...
											<div class="modal-body">
												<form id="filter-form" method="GET" action="<?php echo e(route('dashboard.general_export')); ?>">
