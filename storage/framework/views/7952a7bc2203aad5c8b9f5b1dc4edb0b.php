...
<div class="main">
	...
	<div class="body-note mt-4 mb-4">
        ...
        <strong><?php echo e(number_format($projectInvestor->investor_final_profit, 2)); ?></strong> por concepto del proyecto <strong><?php echo e($project->project_name); ?></strong> con fecha de inicio el día <strong><?php echo e($project->project_start_date); ?></strong> y fecha de finalización <strong><?php echo e($project->project_end_date); ?></strong>. Así mismo se hace el retorno de la inversión por un valor de <strong>L. <?php echo e(number_format($project->project_investment,2)); ?></strong>.
		<br>
		<br>
		<br>
	</div>
...
</style><?php /**PATH R:\Code\En proceso\InvestorInsight\resources\views/modules/payment_investors/_report.blade.php ENDPATH**/ ?>