    ...
    <?php if(session('credit_note_id')): ?>
        <script>
            ...
            function redirectToCreditNote() {
                window.location.href = "<?php echo e(route('credit_note.report_download', session('credit_note_id'))); ?>";
            }        
        </script>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carlos Rodriguez\Downloads\InvestorInsight\resources\views/modules/credit_note/index.blade.php ENDPATH**/ ?>