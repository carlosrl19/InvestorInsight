    ...
    <tbody>
        ...
        <tr style="border: 1px solid #000">
            ...
            <td style="font-size: 14px; width: 100px; font-weight: bold; background-color: #fff; text-align: left; text-align: center; text-decoration: underline;">
                MOVIMIENTO DE FONDOS <?php echo e(implode(' ', array_slice(explode(' ', $investor->investor_name), 0, 1))); ?> <?php echo e(implode(' ', array_slice(explode(' ', $investor->investor_name), -1))); ?>
        ...
        <!-- Content table -->
        <?php $__currentLoopData = $investor_funds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr style="border: 1px solid #000">
            <td></td>
            <td style="background-color: #fff; text-align: center;"><?php echo e($fund->investor_change_date); ?></td>
            <td style="background-color: #fff; text-align: center;"><?php echo e($fund->investor_new_funds - $fund->investor_old_funds); ?></td>
            <td style="background-color: #fff; text-align: center;"><?php echo e($fund->investor_old_funds); ?></td>
            <td style="background-color: #fff; text-align: center;"><?php echo e($fund->investor_new_funds); ?></td>
            <td style="background-color: #fff; text-align: center;"><?php echo e($fund->investor_new_funds_comment); ?></td>
            <td style="background-color: #fff;"></td>
            <td style="background-color: #fff;"></td>
        </tr>
...
<?php /**PATH C:\Users\Carlos Rodriguez\Desktop\Code\InvestorInsight - experimental\resources\views/modules/investors_funds/_report_excel.blade.php ENDPATH**/ ?>