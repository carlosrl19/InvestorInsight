                ...
                <tbody>
                    <?php $__currentLoopData = $promissoryNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promissoryNote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-center">
                            ...
                            <?php if($promissoryNote->promissoryNote_status == '1'): ?>
                                <td>
                                    <a href="<?php echo e(route('promissory_note.report', $promissoryNote->id)); ?>" class="btn btn-sm btn-success"
                                        data-toggle="modal" data-target="#pdfModal" style="padding-right: 20px; font-size: clamp(0.6rem, 3vw, 0.7rem)">
                                        &nbsp;&nbsp;&nbsp;<img style="filter: invert(99%) sepia(43%) saturate(0%) hue-rotate(95deg) brightness(110%) contrast(101%);" src="<?php echo e(asset('../static/svg/currency-dollar.svg')); ?>" width="20" height="20" alt="">
                                        &nbsp;PAGAR
                                    </a>
                                </td>
                            <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carlos Rodriguez\Desktop\Code\InvestorInsight - experimental\resources\views/modules/promissory_note/index.blade.php ENDPATH**/ ?>