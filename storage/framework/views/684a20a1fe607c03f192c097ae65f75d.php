...
<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <?php else: ?>
                    <td style="background-color: #fff; font-size: 11px; font-weight: bold; width: 150px; text-align: center;">
                        <?php echo e(implode(' ', array_slice(explode(' ', $project->investors[0]->investor_name), 0, 1))); ?> 50%
                    </td>
                <?php endif; ?>
    ...
    <br>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\Users\Carlos Rodriguez\Desktop\Code\InvestorInsight - experimental\resources\views/modules/projects/_report_active_investor_project_excel.blade.php ENDPATH**/ ?>