                            ...
                            <tbody>
                                <?php $__currentLoopData = $investorLiquidations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investorLiquidation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-red" style="font-size: clamp(0.6rem, 3vw, 0.6rem)" href="<?php echo e(route('investors_liquidations.report_download', $investorLiquidation)); ?>" data-toggle="modal" data-target="#pdfModal">
...
</script><?php /**PATH C:\Users\Carlos Rodriguez\Desktop\Code\InvestorInsight - experimental\resources\views/modules/investors_liquidations/index.blade.php ENDPATH**/ ?>