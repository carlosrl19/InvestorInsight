                                        ...
                                        <div class="row mb-3 align-items-end">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" maxlength="55" oninput="this.value = this.value.toUpperCase()" value="<?php echo e($moneylender->moneylender_name); ?>" name="moneylender_name" id="moneylender_name_<?php echo e($moneylender->id); ?>" class="form-control <?php $__errorArgs = ['moneylender_name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Ingrese el nombre del prestamista" autocomplete="off"/>
...
unset($__errorArgs, $__bag); ?>
                                                    <label for="moneylender_name_<?php echo e($moneylender->id); ?>">Nombre del prestamista</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" maxlength="13" value="<?php echo e($moneylender->moneylender_dni); ?>" name="moneylender_dni" id="moneylender_dni_<?php echo e($moneylender->id); ?>" class="form-control <?php $__errorArgs = ['moneylender_dni'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row mb-3 align-items-end">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" name="moneylender_phone" value="<?php echo e($moneylender->moneylender_phone); ?>" id="moneylender_phone_<?php echo e($moneylender->id); ?>" class="form-control <?php $__errorArgs = ['moneylender_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        autocomplete="off" oninput="this.value = this.value.toUpperCase()"><?php echo e($moneylender->moneylender_description); ?></textarea>
